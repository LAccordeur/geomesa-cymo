...
import org.locationtech.geomesa.index.index.cymo.CymoIndexValues
import org.locationtech.geomesa.utils.index.ByteArrays
import org.locationtech.sfcurve.zorder.Z3

class CymoZ3Filter(val xy: Array[Array[Int]], val t: Array[Array[Array[Int]]], val minEpoch: Short, val maxEpoch: Short) {
  ...
  override def toString: String = CymoZ3Filter.serializeToStrings(this).toSeq.sortBy(_._1).mkString(",")
}
...
object CymoZ3Filter {
  ...
  def apply(values: CymoIndexValues): CymoZ3Filter = {
    val CymoIndexValues(_, spatialBounds, _, _, sfc, temporalBounds) = values
    ...
    new CymoZ3Filter(xy, t, minEpoch, maxEpoch)
  }

  def serializeToBytes(filter: CymoZ3Filter): Array[Byte] = {
  ...
  def deserializeFromBytes(serialized: Array[Byte]): CymoZ3Filter = {
  ...
  def serializeToStrings(filter: CymoZ3Filter): Map[String, String] = {
  ...
  def deserializeFromStrings(serialized: scala.collection.Map[String, String]): CymoZ3Filter = {
