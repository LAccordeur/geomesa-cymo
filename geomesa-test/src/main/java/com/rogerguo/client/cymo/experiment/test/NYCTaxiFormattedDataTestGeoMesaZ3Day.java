 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataTestGeoMesaZ3Day implements CommonData {
    ...
    public NYCTaxiFormattedDataTestGeoMesaZ3Day(String queryFilename, String dataFilename) {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-geomesa-day-baseline";
    }
