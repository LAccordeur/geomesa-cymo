 ...
 * @Created by rogerguo
 */
public class UniformedFormattedDataLargeLargeSubspace implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "uniformed-data-cymo-test-z_txy_168_168_128_128";
    }
    ...
    public List<SimpleFeature> getTestData() {
        if (features == null) {
            ...
            URL input = getClass().getClassLoader().getResource("dataset/uniform_spatial_temporal_points.csv");
            if (input == null) {
                throw new RuntimeException("Couldn't load resource uniform_spatial_temporal_points.csv");
            }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                String bbox = "bbox(geom,0, 0.0901, 0,0.0901)";
                ...
                // test query 1: 100mx100m 1 hour
                String during1 = "dtg DURING 2010-01-02T15:00:00.000Z/2010-01-02T15:59:59.000Z";
                // bounding box over most of the united states
                String bbox1 = "bbox(geom, 0.001000, 0.002000, 0.001000, 0.002000)";
                ...
                // test query 2: 100mx100m 1 hour
                String during2 = "dtg DURING 2010-01-22T18:00:00.000Z/2010-01-22T18:59:59.000Z";
                String bbox2 = "bbox(geom,0.031000, 0.032000, 0.051000, 0.052000)";
                ...
                // test query 3: 100mx100m 1 month
                String during3 = "dtg DURING 2010-01-01T18:00:00.000Z/2010-01-31T19:59:59.000Z";
                String bbox3 = "bbox(geom,0.011000, 0.012000, 0.061000, 0.062000)";
                ...
                // test query 4: 100mx100m 1 month
                String during4 = "dtg DURING 2010-01-01T18:00:00.000Z/2010-01-31T19:59:59.000Z";
                String bbox4 = "bbox(geom,0.001000, 0.002000, 0.061000, 0.062000)";
                ...
                // test query 5: 10000mx10000m 1 hour
                String during5 = "dtg DURING 2010-01-06T05:00:00.000Z/2010-01-06T05:59:59.000Z";
                String bbox5 = "bbox(geom,0.001000, 0.080000, 0.000000, 0.080000)";
                Query query5 = new Query(getTypeName(), ECQL.toFilter(bbox5 + " AND " + during5));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query5.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // test query 6: 10000mx10000m 1 hour
                String during6 = "dtg DURING 2010-01-06T07:00:00.000Z/2010-01-06T07:59:59.000Z";
                String bbox6 = "bbox(geom,0.001000, 0.080000, 0.000000, 0.080000)";
                Query query6 = new Query(getTypeName(), ECQL.toFilter(bbox6 + " AND " + during6));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query6.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // test query 7: 10000mx10000m 1 month
                String during7 = "dtg DURING 2010-01-02T15:05:00.000Z/2010-01-31T15:25:00.000Z";
                String bbox7 = "bbox(geom,0.001000, 0.080000, 0.000000, 0.080000)";
                Query query7 = new Query(getTypeName(), ECQL.toFilter(bbox7 + " AND " + during7));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query7.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // test query 8: 10000mx10000m 1 month
                String during8 = "dtg DURING 2010-01-02T15:05:00.000Z/2010-01-31T15:25:00.000Z";
                String bbox8 = "bbox(geom,0.001000, 0.080000, 0.000000, 0.080000)";
