 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataCymoZTXYFroHybridWeekend implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-cymo-test-hybrid-weekend-ztxy";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                //location-precedence period - location-precedence workload : time-precedence workload = 0.9 : 0.1
                //time-precedence period - location-precedencde wokload : time-precedence workload = 0.1 : 0.9

                // location-precedence period query set
                // query 1: 0.01, 1 month
                String during1 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-31T15:00:00.000Z";
                String bbox1 = "bbox(geom,-73.997000, -73.987000, 40.745000,40.755000)";
                ...
                // query 2: 0.01, 1 month
                String during2 = "dtg DURING 2010-01-02T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox2 = "bbox(geom,-73.997000, -73.987000, 40.755000,40.765000)";
                Query query2 = new Query(getTypeName(), ECQL.toFilter(bbox2 + " AND " + during2));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query2.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 3: 0.01, 1 month
                String during3 = "dtg DURING 2010-01-02T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox3 = "bbox(geom,-73.987000, -73.977000, 40.755000,40.765000)";
                Query query3 = new Query(getTypeName(), ECQL.toFilter(bbox3 + " AND " + during3));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query3.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 4 0.01, 1 month
                String during4 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox4 = "bbox(geom,-73.987000, -73.977000, 40.745000,40.755000)";
                Query query4 = new Query(getTypeName(), ECQL.toFilter(bbox4 + " AND " + during4));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query4.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 5 0.01, 1 month
                String during5 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox5 = "bbox(geom,-73.977000, -73.967000, 40.745000,40.755000)";
                Query query5 = new Query(getTypeName(), ECQL.toFilter(bbox5 + " AND " + during5));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query5.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 6 0.01, 1 month
                String during6 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox6 = "bbox(geom,-73.977000, -73.967000, 40.725000,40.735000)";
                ...
                String during7 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox7 = "bbox(geom,-73.977000, -73.967000, 40.725000,40.735000)";
                ...
                String during8 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox8 = "bbox(geom,-73.997000, -73.987000, 40.725000,40.735000)";
                ...
                String bbox9 = "bbox(geom,-73.997000, -73.987000, 40.775000,40.785000)";
                Query query9 = new Query(getTypeName(), ECQL.toFilter(bbox9 + " AND " + during9));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query9.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 10 0.1, 1 hour
                String during10 = "dtg DURING 2010-01-14T22:00:00.000Z/2010-01-14T22:59:59.000Z";
                String bbox10 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
                ...
                //time-precedence period
                // query 11 0.1, 1 hour
                String during11 = "dtg DURING 2010-01-13T22:00:00.000Z/2010-01-13T22:59:59.000Z";
                ...
                // query 12 0.1, 1 hour
                String during12 = "dtg DURING 2010-01-05T18:00:00.000Z/2010-01-05T18:59:59.000Z";
                ...
                // query 13 0.1, 1 hour
                String during13 = "dtg DURING 2010-01-05T12:00:00.000Z/2010-01-05T12:59:59.000Z";
                ...
                // query 14 0.1, 1 hour
                String during14 = "dtg DURING 2010-01-13T12:00:00.000Z/2010-01-13T12:59:59.000Z";
                ...
                // query 15 0.1, 1 hour
                String during15 = "dtg DURING 2010-01-20T12:00:00.000Z/2010-01-20T12:59:59.000Z";
                ...
                // query 16 0.1, 1 hour
                String during16 = "dtg DURING 2010-01-13T08:00:00.000Z/2010-01-13T08:59:59.000Z";
                ...
                // query 17 0.1, 1 hour
                String during17 = "dtg DURING 2010-01-27T12:00:00.000Z/2010-01-27T12:59:59.000Z";
                ...
                // query 18 0.1, 1 hour
                String during18 = "dtg DURING 2010-01-13T01:00:00.000Z/2010-01-13T01:59:59.000Z";
                ...
                // query 19 0.1, 1 hour
                String during19 = "dtg DURING 2010-01-05T16:00:00.000Z/2010-01-05T16:59:59.000Z";
                ...
                // query 20 0.01, 1 month
                String during20 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox20 = "bbox(geom,-73.987000, -73.977000, 40.765000,40.775000)";
                ...
                // workload 2
                // query 10 0.1, 1 hour
                String during21 = "dtg DURING 2010-01-11T21:00:00.000Z/2010-01-11T21:59:59.000Z";
                String bbox21 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
                Query query21 = new Query(getTypeName(), ECQL.toFilter(bbox21 + " AND " + during21));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query21.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // workload 3
                String during22 = "dtg DURING 2010-01-11T11:00:00.000Z/2010-01-11T11:59:59.000Z";
                String bbox22 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
                Query query22 = new Query(getTypeName(), ECQL.toFilter(bbox22 + " AND " + during22));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query22.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // workload 4
                String during23 = "dtg DURING 2010-01-11T10:00:00.000Z/2010-01-11T10:59:59.000Z";
                String bbox23 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
