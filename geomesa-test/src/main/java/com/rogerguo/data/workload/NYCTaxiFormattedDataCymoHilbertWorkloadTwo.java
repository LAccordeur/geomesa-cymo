 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataCymoHilbertWorkloadTwo implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-cymo-test-workload-hilbert";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                String bbox10 = "bbox(geom,-73.987000, -73.977000, 40.765000,40.775000)";
