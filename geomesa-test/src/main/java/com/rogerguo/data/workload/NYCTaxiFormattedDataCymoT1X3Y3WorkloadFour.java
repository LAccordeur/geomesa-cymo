 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataCymoT1X3Y3WorkloadFour implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-cymo-test-workload-t1x3y3";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                // query 11 0.1, 1 hour
                String during1 = "dtg DURING 2010-01-16T22:00:00.000Z/2010-01-16T22:59:59.000Z";
                ...
                // query 12 0.1, 1 hour
                String during2 = "dtg DURING 2010-01-02T18:00:00.000Z/2010-01-02T18:59:59.000Z";
                ...
                // query 13 0.1, 1 hour
                String during3 = "dtg DURING 2010-01-02T12:00:00.000Z/2010-01-02T12:59:59.000Z";
                ...
                // query 14 0.1, 1 hour
                String during4 = "dtg DURING 2010-01-16T12:00:00.000Z/2010-01-16T12:59:59.000Z";
                ...
                // query 17 0.1, 1 hour
                String during7 = "dtg DURING 2010-01-02T12:00:00.000Z/2010-01-02T12:59:59.000Z";
                String bbox7 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
                Query query7 = new Query(getTypeName(), ECQL.toFilter(bbox7 + " AND " + during7));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query7.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 18 0.1, 1 hour
                String during8 = "dtg DURING 2010-01-02T01:00:00.000Z/2010-01-02T01:59:59.000Z";
                String bbox8 = "bbox(geom,-74.047000, -73.947000, 40.705000,40.805000)";
                Query query8 = new Query(getTypeName(), ECQL.toFilter(bbox8 + " AND " + during8));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query8.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 19 0.1, 1 hour
                String during9 = "dtg DURING 2010-01-16T16:00:00.000Z/2010-01-16T16:59:59.000Z";
                String bbox9 = "bbox(geom,-74.057000, -73.957000, 40.705000,40.805000)";
                ...
                // query 20 0.1, 1 hour
                String during10 = "dtg DURING 2010-01-29T04:00:00.000Z/2010-01-29T04:59:59.000Z";
