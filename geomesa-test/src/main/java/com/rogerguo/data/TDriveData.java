...
public class TDriveData implements CommonData {
    ...
    public List<SimpleFeature> getTestData() {
        if (features == null) {
            ...
            URL input = getClass().getClassLoader().getResource("dataset/1277-reduced.txt");
            if (input == null) {
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                String during = "dtg DURING 2008-02-02T15:00:00.000Z/2008-02-02T15:35:00.000Z";
                // bounding box over most of the united states
                String bbox = "bbox(geom,110,120,30,50)";
                 ...
                 * guoyang
                 */
                String myquery = "taxiId = 1277";
                queries.add(new Query(getTypeName(), ECQL.toFilter(myquery)));
