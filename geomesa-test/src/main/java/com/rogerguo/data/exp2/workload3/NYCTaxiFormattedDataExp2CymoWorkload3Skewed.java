 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataExp2CymoWorkload3Skewed implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-exp2-cymo-test-workload3-skewed";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                // query 6 0.1, 1 hour
                String during6 = "dtg DURING 2010-01-12T08:00:00.000Z/2010-01-12T08:59:59.000Z";
