package com.rogerguo.data.exp2.baseline;
 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataExp2GeoMesaZ3Workload1Single implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-exp2-geomesa-test-z3";
    }
