package com.rogerguo.data.exp2.workload1;
 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataExp2CymoWorkload1MultiplePattern implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-exp2-cymo-test-workload1";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                // region A (3) 0,01 1 hour & (2) 0.1 1 hour
                // query 1 0.01, 1 hour
                ...
                // query 5 0.1, 1 hour
                String during5 = "dtg DURING 2010-01-12T12:00:00.000Z/2010-01-12T12:59:59.000Z";
                ...
                // region B (3) 0.1 1 hour & (2) 0.01 1 hour
                ...
                // query 9 0.01, 1 hour
                String during9 = "dtg DURING 2010-01-02T16:00:00.000Z/2010-01-02T16:59:59.000Z";
                String bbox9 = "bbox(geom,-73.947000, -73.937000, 40.705000,40.715000)";
                Query query9 = new Query(getTypeName(), ECQL.toFilter(bbox9 + " AND " + during9));
                //query4.getHints().put(QueryHints.LOOSE_BBOX(), Boolean.TRUE);
                query9.getHints().put(QueryHints.QUERY_INDEX(), "cymo");

                // query 10 0.01, 1 hour
                String during10 = "dtg DURING 2010-01-16T04:00:00.000Z/2010-01-16T04:59:59.000Z";
                String bbox10 = "bbox(geom,-73.957000, -73.947000, 40.725000,40.735000)";
