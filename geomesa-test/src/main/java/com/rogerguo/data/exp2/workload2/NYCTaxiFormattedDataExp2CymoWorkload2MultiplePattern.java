 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataExp2CymoWorkload2MultiplePattern implements CommonData {
    ...
    public String getTypeName() {
        ...
        return "nyc-taxi-data-exp2-cymo-test-workload2";
    }
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                // location-precedence period query set  -73.977000, -73.967000, 40.715000,40.735000
                // query 1 0.001, 1 month
                String during1 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox1 = "bbox(geom,-73.977000, -73.976000, 40.734000,40.735000)";
                ...
                String during2 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox2 = "bbox(geom,-73.973000, -73.972000, 40.734000,40.735000)";
                ...
                String during3 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox3 = "bbox(geom,-73.973000, -73.972000, 40.730000,40.731000)";
                ...
                String bbox4 = "bbox(geom,-73.977000, -73.967000, 40.725000,40.735000)";
                ...
                String bbox5 = "bbox(geom,-73.987000, -73.977000, 40.717000,40.727000)";
                ...
                String during6 = "dtg DURING 2010-01-01T15:00:00.000Z/2010-01-31T15:00:00.000Z";
                String bbox6 = "bbox(geom,-73.997000, -73.987000, 40.745000,40.755000)";
                ...
                String during7 = "dtg DURING 2010-01-02T15:00:00.000Z/2010-01-30T15:00:00.000Z";
                String bbox7 = "bbox(geom,-73.997000, -73.987000, 40.755000,40.765000)";
                ...
                String bbox8 = "bbox(geom,-73.987000, -73.977000, 40.745000,40.755000)";
                ...
                String bbox9 = "bbox(geom,-73.977000, -73.976000, 40.746000,40.747000)";
                ...
                String bbox10 = "bbox(geom,-73.988000, -73.987000, 40.765000,40.766000)";
