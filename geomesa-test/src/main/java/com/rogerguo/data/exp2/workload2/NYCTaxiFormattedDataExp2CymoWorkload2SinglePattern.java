 ...
 * @Created by rogerguo
 */
public class NYCTaxiFormattedDataExp2CymoWorkload2SinglePattern implements CommonData {
    ...
    public List<Query> getTestQueries() {
        if (queries == null) {
            ...
            try {
                ...
                String bbox4 = "bbox(geom,-73.968000, -73.967000, 40.725000,40.726000)";
                ...
                String bbox5 = "bbox(geom,-73.968000, -73.967000, 40.717000,40.718000)";
                ...
                String bbox9 = "bbox(geom,-73.977000, -73.967000, 40.745000,40.755000)";
                ...
                String bbox10 = "bbox(geom,-73.997000, -73.987000, 40.765000,40.775000)";
